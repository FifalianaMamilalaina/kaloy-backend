  ...
  <div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <GenesisButton
          title="Create new eventModerationStatuse"
          @click="goToCreateFormView"
          class="btn-secondary"
        >
          <PlusIcon />
          {{ $t('button.addEntity', { entity: 'EventModerationStatuse' }) }}
        </GenesisButton>
      </div>
    </div>
    ...
    <EntityTable
      ...
      :searchFn="searchEventModerationStatuses"
      :getPaginationData="getPaginationData"
      :listComponent="EventModerationStatuseList"
      :entities="eventModerationStatuses"
      :message="message"
...
import EventModerationStatuseList from '@/entities/eventModerationStatuse/EventModerationStatuseList.vue'
...
const searchFields = ref<EntitySearchField[]>(EventModerationStatuse.getAllSearchFieldsMetadata())
...
const onExport = async () => {
  await exportEventModerationStatusesToCsv(eventModerationStatuses.value)
}
