<template>
  <div class="w-full">
    ...
    <!-- Entity details -->
    <MediaTypeDetails v-if="entity" :mediaType="entity" />
  </div>
</template>
...
import MediaTypeDetails from '@/entities/mediaType/MediaTypeDetails.vue'
...
const { getMediaTypeById, goToListView } = useMediaTypes()
