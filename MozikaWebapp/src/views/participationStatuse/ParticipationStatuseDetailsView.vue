<template>
  <div class="w-full">
    ...
    <!-- Entity details -->
    <ParticipationStatuseDetails v-if="entity" :participationStatuse="entity" />
  </div>
</template>
...
import ParticipationStatuseDetails from '@/entities/participationStatuse/ParticipationStatuseDetails.vue'
...
const { getParticipationStatuseById, goToListView } = useParticipationStatuses()
