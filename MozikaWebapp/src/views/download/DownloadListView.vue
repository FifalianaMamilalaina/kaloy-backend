  ...
  <div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        >
          <PlusIcon />
          {{ $t('button.addEntity', { entity: 'Download' }) }}
        </GenesisButton>
      </div>
    </div>
...
const searchFields = ref<EntitySearchField[]>(Download.getAllSearchFieldsMetadata())
...
const onExport = async () => {
  await exportDownloadsToCsv(downloads.value)
}
