  ...
  <div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <GenesisButton title="Create new report" @click="goToCreateFormView" class="btn-secondary">
          <PlusIcon />
          {{ $t('button.addEntity', { entity: 'Report' }) }}
        </GenesisButton>
      </div>
    </div>
...
const searchFields = ref<EntitySearchField[]>(Report.getAllSearchFieldsMetadata())
...
const onExport = async () => {
  await exportReportsToCsv(reports.value)
}
