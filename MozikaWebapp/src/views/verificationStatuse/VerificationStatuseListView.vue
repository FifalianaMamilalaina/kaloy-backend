  ...
  <div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <GenesisButton
          title="Create new verificationStatuse"
          @click="goToCreateFormView"
          class="btn-secondary"
        >
          <PlusIcon />
          {{ $t('button.addEntity', { entity: 'VerificationStatuse' }) }}
        </GenesisButton>
      </div>
    </div>
    ...
    <EntityTable
      ...
      :searchFn="searchVerificationStatuses"
      :getPaginationData="getPaginationData"
      :listComponent="VerificationStatuseList"
      :entities="verificationStatuses"
      :message="message"
...
import VerificationStatuseList from '@/entities/verificationStatuse/VerificationStatuseList.vue'
...
const searchFields = ref<EntitySearchField[]>(VerificationStatuse.getAllSearchFieldsMetadata())
...
const onExport = async () => {
  await exportVerificationStatusesToCsv(verificationStatuses.value)
}
