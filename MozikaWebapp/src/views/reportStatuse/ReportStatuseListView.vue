  ...
  <div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <GenesisButton
          title="Create new reportStatuse"
          @click="goToCreateFormView"
          class="btn-secondary"
        >
          <PlusIcon />
          {{ $t('button.addEntity', { entity: 'ReportStatuse' }) }}
        </GenesisButton>
      </div>
    </div>
    ...
    <EntityTable
      ...
      :searchFn="searchReportStatuses"
      :getPaginationData="getPaginationData"
      :listComponent="ReportStatuseList"
      :entities="reportStatuses"
      :message="message"
...
import ReportStatuseList from '@/entities/reportStatuse/ReportStatuseList.vue'
...
const searchFields = ref<EntitySearchField[]>(ReportStatuse.getAllSearchFieldsMetadata())
...
const onExport = async () => {
  await exportReportStatusesToCsv(reportStatuses.value)
}
