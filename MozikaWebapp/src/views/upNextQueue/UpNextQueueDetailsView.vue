<template>
  <div class="w-full">
    ...
    <!-- Entity details -->
    <UpNextQueueDetails v-if="entity" :upNextQueue="entity" />
  </div>
</template>
...
import UpNextQueueDetails from '@/entities/upNextQueue/UpNextQueueDetails.vue'
...
const { getUpNextQueueById, goToListView } = useUpNextQueues()
