  ...
  <div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <GenesisButton
          title="Create new userStatusHistory"
          @click="goToCreateFormView"
          class="btn-secondary"
        >
          <PlusIcon />
          {{ $t('button.addEntity', { entity: 'UserStatusHistory' }) }}
        </GenesisButton>
      </div>
    </div>
    ...
    <EntityTable
      ...
      :searchFn="searchUserStatusHistorys"
...
const searchFields = ref<EntitySearchField[]>(UserStatusHistory.getAllSearchFieldsMetadata())
...
const onExport = async () => {
  await exportUserStatusHistorysToCsv(userStatusHistorys.value)
}
