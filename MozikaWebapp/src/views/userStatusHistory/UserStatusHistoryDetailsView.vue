<template>
  <div class="w-full">
    ...
    <!-- Entity details -->
    <UserStatusHistoryDetails v-if="entity" :userStatusHistory="entity" />
  </div>
</template>
...
import UserStatusHistoryDetails from '@/entities/userStatusHistory/UserStatusHistoryDetails.vue'
...
const { getUserStatusHistoryById, goToListView } = useUserStatusHistorys()
