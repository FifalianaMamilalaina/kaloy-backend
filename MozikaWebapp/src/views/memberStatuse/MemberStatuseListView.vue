  ...
  <div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <GenesisButton
          title="Create new memberStatuse"
          @click="goToCreateFormView"
          class="btn-secondary"
        >
          <PlusIcon />
          {{ $t('button.addEntity', { entity: 'MemberStatuse' }) }}
        </GenesisButton>
      </div>
    </div>
    ...
    <EntityTable
      ...
      :searchFn="searchMemberStatuses"
      :getPaginationData="getPaginationData"
      :listComponent="MemberStatuseList"
      :entities="memberStatuses"
      :message="message"
...
import MemberStatuseList from '@/entities/memberStatuse/MemberStatuseList.vue'
...
const searchFields = ref<EntitySearchField[]>(MemberStatuse.getAllSearchFieldsMetadata())
...
const onExport = async () => {
  await exportMemberStatusesToCsv(memberStatuses.value)
}
