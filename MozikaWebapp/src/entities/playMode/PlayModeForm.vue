...
import { ref } from 'vue'
import { PlayMode, PlayModeFormDTO } from '@/models/PlayModeModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<PlayModeFormDTO>): void
  (e: 'cancel', payload: Partial<PlayModeFormDTO>): void
}>()

const formModel = ref<Partial<PlayModeFormDTO>>({ ...PlayModeFormDTO.parse(props.playMode) })
