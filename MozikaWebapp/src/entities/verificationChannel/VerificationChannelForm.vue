...
import {
  VerificationChannel,
  VerificationChannelFormDTO,
} from '@/models/VerificationChannelModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<VerificationChannelFormDTO>): void
  (e: 'cancel', payload: Partial<VerificationChannelFormDTO>): void
}>()

const formModel = ref<Partial<VerificationChannelFormDTO>>({
  ...VerificationChannelFormDTO.parse(props.verificationChannel),
})
