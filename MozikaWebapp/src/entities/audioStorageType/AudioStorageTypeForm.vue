...
import { ref } from 'vue'
import { AudioStorageType, AudioStorageTypeFormDTO } from '@/models/AudioStorageTypeModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<AudioStorageTypeFormDTO>): void
  (e: 'cancel', payload: Partial<AudioStorageTypeFormDTO>): void
}>()

const formModel = ref<Partial<AudioStorageTypeFormDTO>>({
  ...AudioStorageTypeFormDTO.parse(props.audioStorageType),
})
