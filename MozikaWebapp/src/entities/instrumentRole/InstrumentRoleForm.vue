    ...
    <div class="card-body">
      <form @submit.prevent="handleSubmit" class="grid grid-cols-1 w-7/12 gap-4 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-4">
          ...
          <GenesisInput
            label="Label"
            :violation="violations ? violations['label'] : undefined"
...
import { ref } from 'vue'
import { InstrumentRole, InstrumentRoleFormDTO } from '@/models/InstrumentRoleModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<InstrumentRoleFormDTO>): void
  (e: 'cancel', payload: Partial<InstrumentRoleFormDTO>): void
}>()

const formModel = ref<Partial<InstrumentRoleFormDTO>>({
  ...InstrumentRoleFormDTO.parse(props.instrumentRole),
})
