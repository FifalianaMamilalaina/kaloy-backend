...
import { ref } from 'vue'
import { UserRole, UserRoleFormDTO } from '@/models/UserRoleModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<UserRoleFormDTO>): void
  (e: 'cancel', payload: Partial<UserRoleFormDTO>): void
}>()

const formModel = ref<Partial<UserRoleFormDTO>>({ ...UserRoleFormDTO.parse(props.userRole) })
