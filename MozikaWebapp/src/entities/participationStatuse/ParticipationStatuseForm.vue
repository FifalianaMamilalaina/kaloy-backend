...
} from '@/models/ParticipationStatuseModel.ts'
import GenesisButton from '@/components/button/GenesisButton.vue'
import GenesisInput from '@/components/form/GenesisInput.vue'

const props = defineProps<{
  participationStatuse?: ParticipationStatuse
  violations?: Record<string, string> | null
  submitLabel?: string
}>()

const emit = defineEmits<{
  (e: 'submit', payload: Partial<ParticipationStatuseFormDTO>): void
  (e: 'cancel', payload: Partial<ParticipationStatuseFormDTO>): void
}>()

const formModel = ref<Partial<ParticipationStatuseFormDTO>>({
  ...ParticipationStatuseFormDTO.parse(props.participationStatuse),
})
