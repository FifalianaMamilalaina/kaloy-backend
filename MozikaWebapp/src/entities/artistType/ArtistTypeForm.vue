...
import { ref } from 'vue'
import { ArtistType, ArtistTypeFormDTO } from '@/models/ArtistTypeModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<ArtistTypeFormDTO>): void
  (e: 'cancel', payload: Partial<ArtistTypeFormDTO>): void
}>()

const formModel = ref<Partial<ArtistTypeFormDTO>>({ ...ArtistTypeFormDTO.parse(props.artistType) })
