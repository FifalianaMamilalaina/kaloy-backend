...
import { ref } from 'vue'
import { InteractionTarget, InteractionTargetFormDTO } from '@/models/InteractionTargetModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<InteractionTargetFormDTO>): void
  (e: 'cancel', payload: Partial<InteractionTargetFormDTO>): void
}>()

const formModel = ref<Partial<InteractionTargetFormDTO>>({
  ...InteractionTargetFormDTO.parse(props.interactionTarget),
})
