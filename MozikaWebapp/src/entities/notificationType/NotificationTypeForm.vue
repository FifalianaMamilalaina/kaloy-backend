...
import { ref } from 'vue'
import { NotificationType, NotificationTypeFormDTO } from '@/models/NotificationTypeModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<NotificationTypeFormDTO>): void
  (e: 'cancel', payload: Partial<NotificationTypeFormDTO>): void
}>()

const formModel = ref<Partial<NotificationTypeFormDTO>>({
  ...NotificationTypeFormDTO.parse(props.notificationType),
})
