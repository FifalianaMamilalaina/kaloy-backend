...
import {
  VerificationStatuse,
  VerificationStatuseFormDTO,
} from '@/models/VerificationStatuseModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<VerificationStatuseFormDTO>): void
  (e: 'cancel', payload: Partial<VerificationStatuseFormDTO>): void
}>()

const formModel = ref<Partial<VerificationStatuseFormDTO>>({
  ...VerificationStatuseFormDTO.parse(props.verificationStatuse),
})
