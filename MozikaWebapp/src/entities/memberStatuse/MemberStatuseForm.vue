...
import { ref } from 'vue'
import { MemberStatuse, MemberStatuseFormDTO } from '@/models/MemberStatuseModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<MemberStatuseFormDTO>): void
  (e: 'cancel', payload: Partial<MemberStatuseFormDTO>): void
}>()

const formModel = ref<Partial<MemberStatuseFormDTO>>({
  ...MemberStatuseFormDTO.parse(props.memberStatuse),
})
