<template>
  <div class="w-full bg-base-100 border rounded border-base-300 p-4">
    <h3 class="text-lg font-semibold mb-4 text-gray-700">Concert</h3>
      ...
      <table class="table w-full">
        <thead>
          <tr class="text-primary-focus">
            ...
            <th class="">Statusid participation statuses</th>
            <th class="">Responded at</th>
            <th class="">Createdbyartistid artists</th>
...
import ConcertRowForm from '@/entities/concert/ConcertRowForm.vue'
import GenesisInput from '@/components/form/GenesisInput.vue'
import PlusIcon from '@/components/icons/PlusIcon.vue'

const rowToAdd = ref(10)
const props = defineProps<{
  getTableDataCallback: (data: ConcertFormDTO[]) => void
  initialData?: Concert[]
  violations?: Record<string, string>[]
}>()

const { rows, addRow, removeRow, getTableData } = useTableForm<Concert, ConcertFormDTO>(
  props.initialData,
)
