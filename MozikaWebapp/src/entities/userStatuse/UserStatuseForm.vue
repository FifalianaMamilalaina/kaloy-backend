...
import { ref } from 'vue'
import { UserStatuse, UserStatuseFormDTO } from '@/models/UserStatuseModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<UserStatuseFormDTO>): void
  (e: 'cancel', payload: Partial<UserStatuseFormDTO>): void
}>()

const formModel = ref<Partial<UserStatuseFormDTO>>({
  ...UserStatuseFormDTO.parse(props.userStatuse),
})
