...
import {
  PlaylistVisibilitie,
  PlaylistVisibilitieFormDTO,
} from '@/models/PlaylistVisibilitieModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<PlaylistVisibilitieFormDTO>): void
  (e: 'cancel', payload: Partial<PlaylistVisibilitieFormDTO>): void
}>()

const formModel = ref<Partial<PlaylistVisibilitieFormDTO>>({
  ...PlaylistVisibilitieFormDTO.parse(props.playlistVisibilitie),
})
