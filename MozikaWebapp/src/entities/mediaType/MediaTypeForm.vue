...
import { ref } from 'vue'
import { MediaType, MediaTypeFormDTO } from '@/models/MediaTypeModel.ts'
...
const emit = defineEmits<{
  (e: 'submit', payload: Partial<MediaTypeFormDTO>): void
  (e: 'cancel', payload: Partial<MediaTypeFormDTO>): void
}>()

const formModel = ref<Partial<MediaTypeFormDTO>>({ ...MediaTypeFormDTO.parse(props.mediaType) })
