...
import { ref } from 'vue'
import { SubmissionStatuse, SubmissionStatuseFormDTO } from '@/models/SubmissionStatuseModel.ts'
import GenesisButton from '@/components/button/GenesisButton.vue'
import GenesisInput from '@/components/form/GenesisInput.vue'

const props = defineProps<{
  submissionStatuse?: SubmissionStatuse
  violations?: Record<string, string> | null
  submitLabel?: string
}>()

const emit = defineEmits<{
  (e: 'submit', payload: Partial<SubmissionStatuseFormDTO>): void
  (e: 'cancel', payload: Partial<SubmissionStatuseFormDTO>): void
}>()

const formModel = ref<Partial<SubmissionStatuseFormDTO>>({
  ...SubmissionStatuseFormDTO.parse(props.submissionStatuse),
})
