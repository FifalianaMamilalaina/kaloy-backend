...
import { ref } from 'vue'
import { ReportStatuse, ReportStatuseFormDTO } from '@/models/ReportStatuseModel.ts'
import GenesisButton from '@/components/button/GenesisButton.vue'
import GenesisInput from '@/components/form/GenesisInput.vue'

const props = defineProps<{
  reportStatuse?: ReportStatuse
  violations?: Record<string, string> | null
  submitLabel?: string
}>()

const emit = defineEmits<{
  (e: 'submit', payload: Partial<ReportStatuseFormDTO>): void
  (e: 'cancel', payload: Partial<ReportStatuseFormDTO>): void
}>()

const formModel = ref<Partial<ReportStatuseFormDTO>>({
  ...ReportStatuseFormDTO.parse(props.reportStatuse),
})
