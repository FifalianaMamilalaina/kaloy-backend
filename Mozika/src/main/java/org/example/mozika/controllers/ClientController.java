...
public class ClientController  {
	...
	@Operation(
	     summary = "Export Client to CSV",
	     description = "Generate a CSV file from a provided list of Client objects."
	)
	@ApiResponses({
	   @ApiResponse(
	   responseCode = "200",
	...
	public ResponseEntity<byte[]> exportClientToCsv(@RequestBody List<Client> client) {
	  
	  String csvContent = clientService.exportClientToCSV(client);
