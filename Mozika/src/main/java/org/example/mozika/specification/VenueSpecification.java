...
public class VenueSpecification {
    ...
    public static Specification<Venue> filter(VenueSearch object) {
        return (root, query, criteriaBuilder) -> {
            ...
            System.out.println("🔍 TEMPLATE DEBUG: name=location | columnType=[varchar] | isText=true | isNumeric=false");

            
            WebUtils.addLikeIfPresent(criteriaBuilder, root.get("location"), object.getLocation(), predicates);
